...
def everything():
    ...
    adseq = sc.read_h5ad(path2+'reference.h5ad')
    adspa = sc.read_h5ad(path1+'query.h5ad')
    #adspa.X =adspa.raw.X
    ...
    tc.tl.annotate(adspa,adseq,'cell_type',result_key='Tacco_singleCell_OT',multi_center=None,method='OT')
    #tc.tl.annotate(adspa,adseq,'cluster',result_key='Tacco_singleCell_WOT',multi_center=None,method='WOT')
    tc.tl.annotate(adspa,adseq,'cell_type',result_key='Tacco_singleCell_withoutmulticenter')
